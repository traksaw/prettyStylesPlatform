    ...
    <section id="services" className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Our Services & Pricing</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Professional braiding services with hair included. All prices include premium quality hair extensions.
          </p>
          <Badge variant="secondary" className="mt-4 bg-pink-100 text-pink-700">
          ...
          {services.map((service, index) => (
            <Card key={index} className="border-pink-200 hover:shadow-lg transition-shadow">
              <CardHeader className="bg-pink-50">
                <CardTitle className="text-pink-700">{service.category}</CardTitle>
        ...
        <Card className="border-pink-200 bg-pink-50/50">
          <CardHeader>
            <CardTitle className="text-pink-700">Add-Ons</CardTitle>
            <p className="text-sm text-gray-600">Enhance your style with these optional extras</p>
          </CardHeader>
          <CardContent>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500 italic">*Prices may change depending on hair length and complexity</p>
        </div>
      </div>
    </section>
  )
